...
import { EmailOrderService } from './emailOrderService';
...
export class StripeWebhookHandler {
   ...
   */
  static async handleWebhook(event: StripeWebhookEvent): Promise<void> {
  ...
  private static async handlePaymentSuccess(paymentIntent: PaymentIntent): Promise<void> {
    ...
    try {
      ...
      const emailResult = await EmailOrderService.sendOrderConfirmation(orderEmailData);
   ...
   */
  private static async handlePaymentCanceled(paymentIntent: PaymentIntent): Promise<void> {
  ...
  /**
   * Create a webhook endpoint handler for serverless deployment
   */
 ...
 */
export const stripeWebhookEndpoint = StripeWebhookHandler.createWebhookEndpoint();
...
export const handler = async (req: any, res: any) => {
  ...
  try {
    await StripeWebhookHandler.handleWebhook(req.body);
