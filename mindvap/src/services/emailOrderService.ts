...
import { CalculationService, ShippingAddress } from './calculationService';
...
export class EmailOrderService {
  ...
  static async sendOrderConfirmation(
    ...
    try {
      ...
      console.log('Order confirmation email sent successfully:', orderData.order.id);
  ...
  static async sendOrderShipped(
    ...
    try {
      ...
      console.log('Order shipped email sent successfully:', orderData.order.id);
      return { success: result.success, error: result.error };
    } catch (error) {
  ...
  static async sendOrderCancellation(
    ...
    try {
      ...
      console.log('Order cancellation email would be sent:', {
  ...
  static async sendRefundConfirmation(
    ...
    try {
      ...
      console.log('Refund confirmation email would be sent:', {
        orderId: orderData.order.id,
