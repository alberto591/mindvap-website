...
export class ChatService {
  ...
  static generateBotResponse(userMessage: string): { response: string; quickReplies?: string[] } {
    ...
    // Default response
    return {
      response: 'Thanks for your message! I\'m here to help with any questions about our products, orders, shipping, or account. What would you like to know more about?',
      quickReplies: ['Track my order', 'Product questions', 'Shipping info', 'Contact support']
    };
  }
  ...
  static async getChatStats(startDate?: string, endDate?: string) {
    ...
    const stats = {
      ...
      averageSessionDuration: 0 // Would need to calculate from message timestamps
    };
